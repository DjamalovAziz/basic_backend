...
use crate::data::organization::{
    CreateBranchSurreal, CreateOrganizationSurreal, GetBranchSurreal, GetOrganizationSurreal, PatchBranchSurreal,
...
use domain::repositories::organization::{BranchQueryParams, BranchTrait, OrganizationQueryParams, OrganizationTrait};
...
impl OrganizationTrait for OrganizationSurrealRepository {
    ...
    async fn delete(&self, current_id: String) -> BasicResult<DeleteResponseResult> {
        ...
        match result.is_some() {
            ...
            false => Err(BasicError::not_found_error(String::from("Organization not found!"))),
        }
    }
    ...
    async fn get(&self, current_id: String) -> BasicResult<Organization> {
        ...
        match result {
            Some(organization) => Ok(organization.into()),
            None => Err(BasicError::not_found_error(String::from("Organization not found!"))),
        }
    }
