...
use domain::models::message::{
    CreateFCMSubscription, CreateSubscription, CreateTelegramGroup, PatchTelegramGroup,
};
...
use crate::data::message::{
    CreateFCMSubscriptionSurreal, CreateSubscriptionSurreal, CreateTelegramGroupSurreal,
    GetFCMSubscriptionSurreal, GetSubscriptionSurreal, GetTelegramGroupSurreal, PatchTelegramGroupSurreal,
};
...
impl TelegramGroupTrait for TelegramGroupSurrealRepository {
    ...
    async fn delete(&self, current_id: String) -> BasicResult<DeleteResponseResult> {
        let result: Option<GetTelegramGroupSurreal> =
            self.pool.delete(("telegram_group", current_id)).await?;
    ...
    async fn get(&self, current_id: String) -> BasicResult<TelegramGroup> {
        let result: Option<GetTelegramGroupSurreal> =
            self.pool.select(("telegram_group", current_id)).await?;
